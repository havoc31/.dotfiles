...
static const Key keys[] = {
    ...
    // Volume
    {MODKEY, XK_F1, spawn, SHCMD(volmutecmd)},
    {MODKEY, XK_F2, spawn, SHCMD(voldowncmd)},
    {MODKEY, XK_F3, spawn, SHCMD(volupcmd)},

    // Brightness
    {MODKEY, XK_F4, spawn, SHCMD(brightdowncmd)},
    {MODKEY, XK_F5, spawn, SHCMD(brightupcmd)},
